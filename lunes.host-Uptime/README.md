...
![查看端口](./lunes.host-Uptime/img/0.png)

### 2️⃣ 上传文件并配置权限

**上传项目文件：**

![上传文件](./lunes.host-Uptime/img/1.png)

**为脚本添加 755 执行权限：**

![添加权限](./lunes.host-Uptime/img/2.1.png)
![添加权限](./lunes.host-Uptime/img/2.2.png)
...
![启动命令](./lunes.host-Uptime/img/3.png)

### 5️⃣ 启动服务

点击 **Start** 按钮启动：

![启动](./lunes.host-Uptime/img/4.png)
